...
use dektrium\rbac\events\MenuEvent;
...
class Menu extends Nav
{
    ...
    public function init()
    {
        ...
        $this->view->context->module->trigger(Module::EVENT_MENU, $event);
        
        if (!empty($event->items)) {
            array_push($this->items, $event->items);
        }
        array_push($this->items, $create);
    }
}